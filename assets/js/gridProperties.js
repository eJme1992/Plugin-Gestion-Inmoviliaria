class GridProperties {
			...
			columns: [{
				...
				events: {
					...
					'click .viewResource': function(e, value, row, index) {
						window.open('/wp-admin/gestionar-recursos.php?idProperty=' + row.idPropiedad);
					},
					...
					'click .edit': function(e, value, row, index) {
						window.open('/wp-admin/editar-propiedad.php?idPropiedad=' + row.idPropiedad + '&titulo=' + row.titulo + '&tipoPublicacion=' + row.idTipoDePublicacion + '&precio=' + row.precio + '&direccion=' + row.direccion + '&departamento=' + row.departamento + '&provincia=' + row.provincia + '&distrito=' + row.distrito + '&area=' + row.area + '&latitud=' + row.latitud + '&longitud=' + row.longitud + '&empresa=' + row.empresa + '&urlVideo=' + row.urlVideo + '&descripcion=' + row.descripcion);
					},
	...
	viewProperty(row) {
		...
		$('#modalDepartamento').text(row.departamento);
		$('#modalProvincia').text(row.provincia);
		$('#modalDistrito').text(row.distrito);
		$('#modalArea').text(row.area);
		$('#modalLatitud').text(row.latitud);
		$('#modalLongitud').text(row.longitud);
