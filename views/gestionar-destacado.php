...
<html lang="en">
	<head>
		<title>Gestionar Destacado</title>
		<meta charset="utf-8">
    ...
    <body style="background-color:#F1F1F1">
    			...
    			<div class="col-md-12">
    				<div class="panel panel-primary">
    					<div class="panel-heading text-center">
    						<b class="panel-title">Gestionar Destacado</b>
    					</div>
        ...
        <script type="text/javascript" src="/wp-content/plugins/gestion-inmobiliaria-wp/assets/js/gridDestacado.js"></script>
