...
<html lang="en">
            ...
            <div class="col-md-12">
               <div class="panel panel-primary">
                  <div class="panel-heading text-center">
                     <b class="panel-title">Gestionar Inmueble Internacional</b>
                  </div>
   ...
   <!-- Add -->
      ...
      <script type="text/javascript" src="/wp-content/plugins/gestion-inmobiliaria-wp/assets/js/addPropertyInternational.js"></script>
   <!-- Add -->
   <!-- List -->
      <script type="text/javascript" src="/wp-content/plugins/gestion-inmobiliaria-wp/assets/js/gridPropertyInternational.js"></script>
      <script type="text/javascript" src="/wp-content/plugins/gestion-inmobiliaria-wp/assets/js/gridResourceInternational.js"></script>
      <script type="text/javascript" src="/wp-content/plugins/gestion-inmobiliaria-wp/assets/js/listResourceInternational.js"></script>
   <!-- List -->
</html>